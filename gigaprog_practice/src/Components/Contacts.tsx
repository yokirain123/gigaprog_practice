...
function Contacts() {
  ...
  return (
    <div className="mt-[300px] mb-[150px]">
      ...
      <div className="contact flex justify-center relative rounded-[10px]">
        <div className="w-[436px] h-[554px] absolute bg-white z-40 left-[290px] px-[30px] py-[50px] flex flex-col gap-[40px]">
          <div className="adresses flex flex-col gap-[30px]">
            ...
            <div className="flex flex-col gap-[8px]">
              ...
              <p className="leading-[24px]">+ 38 (096) 000 00 00</p>
              <p className="leading-[24px]">+ 38 (050) 000 00 00</p>
            </div>
            <div className="flex flex-col gap-[8px]">
              ...
              <p className="leading-[24px]">ATS2023@gmail.com</p>
            </div>

            <div className="links flex flex-row gap-[25px]">
              <FaFacebookF className="w-[24px] h-[24px] text-[#152892]" />
              <FaWhatsapp className="w-[24px] h-[24px] text-[#152892]" />
              <FaTelegramPlane className="w-[24px] h-[24px] text-[#152892]" />
            </div>
          </div>
        ...
        <p className="absolute font-semibold text-[24px] text-[#0C143F] z-30 top-[26rem] left-[63rem]">м. Луцьк, вул. Рівненська, 27</p>
